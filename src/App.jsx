...
const PAP_C = [
  {
    ...
    papers: [
      ...
      { t: "Probabilistic Embeddings are Provably Correct", a: "Kirchhof, Kasneci, Oh", v: "ICML 2023", w: "'그 분산이 진짜 맞는 값이냐'는 근본 질문에 수학적 답. 확률적 대조학습이 올바른 aleatoric uncertainty를 복원함을 증명. 이론적 깊이의 정수.", p: "필수", tags: ["Uncertainty", "Theory"], url: "https://arxiv.org/abs/2302.03357" },
      ...
      { t: "Dynamics Reveals Structure: Challenging Linear Propagation", a: "STAI Group", v: "ICML 2026 Spotlight", w: "★최신★ reversal curse, knowledge editing, unlearning이 사실 하나의 기하학적 원인에서 나온다는 주장. 표현이 업데이트 하에서 '어떻게 움직이는지'를 봄. 면접에서 이거 언급하면 '최신 연구 follow한다' 강력 시그널.", p: "필수", tags: ["LLM", "최신", "Geometry"], url: "https://www.linkedin.com/in/seong-joon-oh/" },
